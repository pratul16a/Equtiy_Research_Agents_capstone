...
# Default model — switch to "gpt-4o" if using OpenAI
...
def get_llm():
    ...
    if OPENROUTER_API_KEY:
        ...
        return ChatOpenAI(
            ...
            temperature=0.2,
            default_headers={"HTTP-Referer": "https://equity-research-agent.local"},
        )
    elif GOOGLE_API_KEY:
        ...
        raise ValueError(
            "No API key found. Set OPENROUTER_API_KEY, GOOGLE_API_KEY, or OPENAI_API_KEY in your .env file."
        )
